            ...
            <div className="mx-auto w-full max-w-2xl space-y-8 p-6">
                <header>
                    ...
                    <p className="text-sm text-muted-foreground">
                        Stored locally in this browser. No prompt or response telemetry is collected.
                    </p>
                </header>
                ...
                <section className="space-y-2">
                    ...
                    <p className="text-xs text-muted-foreground">
                        Loopback only. Defaults to http://localhost:11434.
                    </p>
                </section>
                ...
                <section className="space-y-2">
                    ...
                    >
                        {models.length === 0 ? <option value="">no models discovered</option> : null}
                        {models.map((m) => (
                ...
                <section className="space-y-3">
                    <div className="flex items-center justify-between">
                        ...
                        <span className="tag-mono text-primary">{settings.temperature.toFixed(2)}</span>
                    </div>
                    <Slider
                ...
                <section className="space-y-3 rounded-lg border border-border bg-surface p-4">
                    ...
                    <p className="text-xs text-muted-foreground">
                        Conversations live in this browser&apos;s IndexedDB and are retained until you delete
                        them.
                    </p>
